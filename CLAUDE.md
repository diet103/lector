...
- **Next, P2:** `PlaybackService` (MediaSessionService) per PLAN §6 — the player, registry, and OkHttp client move out of `DevSpeakScreen` (which is temporary and dies in P2) into the service + a future `AppContainer`.
